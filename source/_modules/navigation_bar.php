...
<nav class="display-flex d-flex-space-between">
    ...
    <div class="nav-flex-item display-flex">
        ...
        <div class="nav-menu-item hamberger-icon-container"><img src=<?php echo $path_to_hamburger_icon; ?> alt="hamburger" style="cursor: pointer;"></div>
    </div>
</nav>
    ...
    <header class="display-flex d-flex-space-between">
        <div class="ham-header-navigation--item">
            <div class="ham-header-nav__first-section">
                <a class="ham-header-nav__first-section__links display-block big-heading" href="#">HOME</a>
                <a class="ham-header-nav__first-section__links display-block big-heading" href="#">ABOUT</a>
                <a class="ham-header-nav__first-section__links display-block big-heading" href="#">SERVICES</a>
                <a class="ham-header-nav__first-section__links display-block big-heading" href="#">PROJECTS</a>
                <a class="ham-header-nav__first-section__links display-block big-heading" href="#">CONTACT</a>
            </div>
